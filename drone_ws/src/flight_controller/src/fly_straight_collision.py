...
def fly_straight_collision():
    rospy.init_node('fly_straight_collision_node', anonymous=True)
    ...
    # The obstacle is at x=2.5, y=0, z=1.3 (Top at 1.8m)
    # Drone at z=2.0m will clear it, but payload at z~1.7m will hit it.
    ...
    rospy.loginfo("WARNING: Collision anticipated with obstacle at x=2.5")
